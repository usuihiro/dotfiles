...
"  Last Modified: 2010-08-29 19:18
"        Version: 2.22
"=============================================================================
"
"What Is This:
...
function! s:QFixSetup(...)
  ...
  nnoremap <buffer> <silent> i :call QFixTogglePreview()<CR>
  nnoremap <buffer> <silent> <C-h> :call QFixTogglePreviewMode()<CR>
  nnoremap <buffer> <silent> <C-l> :<C-u>call <SID>QFreload()<CR><C-l>
  nnoremap <buffer> <silent> I :call QFixToggleHighlight()<CR>
  ...
  nnoremap <buffer> <silent> S :call QFixSortExec()<CR>
  nnoremap <buffer> <silent> Q :call QFdofe('', 'normal')<CR>
  vnoremap <buffer> <silent> Q :call QFdofe('', 'visual')<CR>
